...
fn help_all() -> String {
    ...
    [
        ...
        &h("deauth", "Deauthentication"), &h("csa", "CSA injection (PMF bypass)"),
        &h("dos", "Denial of service (14 types)"),
...
fn help_one(name: &str) -> String {
    ...
    let info: Option<(&str, &str, &[&str])> = match name {
        ...
        "csa" => Some(("csa", "CSA injection \u{2014} PMF bypass handshake capture.", &["/csa", "/csa RL-WiFi", "/csa stop"])),
